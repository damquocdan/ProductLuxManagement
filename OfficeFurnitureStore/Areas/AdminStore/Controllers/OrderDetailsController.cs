...
namespace OfficeFurnitureStore.Areas.AdminStore.Controllers
{
    ...
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(OfficeFurnitureStoreContext context)
        {
            _context = context;
        }

        // GET: AdminStore/OrderDetails
        public async Task<IActionResult> Index()
        {
            var officeFurnitureStoreContext = _context.OrderDetails.Include(o => o.Order).Include(o => o.Product);
            return View(await officeFurnitureStoreContext.ToListAsync());
        }

        // GET: AdminStore/OrderDetails/Details/5
        ...
        // GET: AdminStore/OrderDetails/Create
        ...
        // POST: AdminStore/OrderDetails/Create
        ...
        // GET: AdminStore/OrderDetails/Edit/5
        ...
        // POST: AdminStore/OrderDetails/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AdminStore/OrderDetails/Delete/5
        ...
        // POST: AdminStore/OrderDetails/Delete/5
